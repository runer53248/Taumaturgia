...
int main() {
    {
        std::cout << "- *********** " << '\n';
        std::cout << "decltype(1) " << parse_type_name<add_properties<Base, Property_unordered<impl::ApplyTag<Damaging_impl, Tags<struct Damage_first>>::template apply>>>() << '\n';
        std::cout << "decltype(2) " << parse_type_name<add_properties<Base, Property_unordered<UserPropertyAdapter<Damage, Tags<struct Damage_first>>::template once>>>() << '\n';
        std::cout << "decltype(3) " << parse_type_name<add_properties<Base, Property_unordered<UserPropertyAdapter<Damage, Tags<struct Damage_first>>::template apply>>>() << '\n';
        std::cout << "- *********** " << '\n'
                  << '\n';
    }

    {
        using test_type1a = add_properties<Base,
                                           Property_unordered<UserPropertyAdapter<Damage, Tags<struct Damage_first>>::template once>,
                                           Property_unordered<impl::ApplyTag<Damaging_impl, Tags<struct Damage_first>>::template apply>,
        ...
        using test_type1b = add_properties<Base,
                                           Property_unordered<UserPropertyAdapter<Damage, Tags<struct Damage_first>>::template apply>,
                                           Property_unordered<impl::ApplyTag<Damaging_impl, Tags<struct Damage_first>>::template apply>,
                                           Property_unordered<UserPropertyAdapter<Damage>::template apply>,
                                           Property_unordered<Damaging_impl>>;
        ...
        std::cout << "ApplyTag<Damaging_impl, Damage_first>::apply == UserPropertyAdapter<Damage, Damage_first>::once: "
                  << std::boolalpha
                  << (Property_unordered<impl::ApplyTag<Damaging_impl, Tags<struct Damage_first>>::template apply>{}   //
                      == Property_unordered<UserPropertyAdapter<Damage, Tags<struct Damage_first>>::template once>{})  // ! later is not forced
                  << '\n';
        ...
        std::cout << "ApplyTag<Damaging_impl, Damage_first>::apply == UserPropertyAdapter<Damage, Damage_first>::apply: "
                  << std::boolalpha
                  << (Property_unordered<impl::ApplyTag<Damaging_impl, Tags<struct Damage_first>>::template apply>{}    //
                      == Property_unordered<UserPropertyAdapter<Damage, Tags<struct Damage_first>>::template apply>{})  // ? both are forced
                  << '\n'
                  << '\n';
...

    {
        auto type_a =
            ...
            | WithUnordered::taged_property<Damaging_impl, Tags<struct Damage_first>>  //
...

    {
        auto type_a =
            Base{}                                                               //
            | WithUnordered::Damage                                              //
            | WithUnordered::user_property<Damage, Tags<struct Damage_first>>          //
            | WithUnordered::taged_property<Damaging_impl, Tags<struct Damage_first>>  //? sometimes duplicate
            | Create;
        auto type_b =
            Base{}                                                               //
            | WithUnordered::taged_property<Damaging_impl>                       //
            | WithUnordered::taged_property<Damaging_impl, Tags<struct Damage_first>>  //
            | WithUnordered::user_property<Damage, Tags<struct Damage_first>>          //? sometimes duplicate
            | Create;
        ...
        std::cout << "WithUnordered::taged_property<Damaging_impl, Damage_first> == WithUnordered::user_property<Damage, Damage_first>: "  //
                  << std::boolalpha
                  << (WithUnordered::taged_property<Damaging_impl, Tags<struct Damage_first>> == WithUnordered::user_property<Damage, Tags<struct Damage_first>>)
                  << '\n'
                  << '\n';
...

    {
        ...
        [[maybe_unused]] list list_1 =                                           //
            ...
            | WithUnordered::user_property<bool, Tags<bool>>                           // 1  : bool
            | WithUnordered::user_property<char, Tags<bool, bool>>                     // 2  : char
            | WithUnordered::user_property<float>                                //*3  : float - (aka. just_float)
            | WithUnordered::user_property<float, Tags<float, int>>                    // 4  : float
            | WithUnordered::Damage                                              // 5  : Damage / impl::Damaging_
            | WithUnordered::user_property<int>                                  // 6  : int
            | WithUnordered::user_property<int, Tags<struct first_int>>                //*7  : int - (aka. int_first::apply)
            | WithUnordered::user_property<std::string, Tags<struct first_string>>     //*8  : string - (aka. string_first::apply)
            | WithUnordered::user_property<std::string, Tags<struct second_string>>    //*9  : string - (aka. string_second::apply)
            | WithUnordered::user_property<double, Tags<struct second_double>>         //*10 : double - (aka. double_second::apply)
            | WithUnordered::user_property<double, Tags<struct first_double>>          //*11 : double - (aka. double_first::apply)
            | WithUnordered::user_property<Damage, Tags<struct Damage_first>>          // 12 : Damage added
            | WithUnordered::taged_property<Damaging_impl, Tags<struct Damage_first>>  // ? -/13 : Damage duplication / impl::Damaging_ added (as different type than impl::UserProperty_<Damage,...>)
