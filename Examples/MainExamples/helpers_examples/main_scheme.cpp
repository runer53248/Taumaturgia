...
int main() {
    ...
    using test_type_new = add_properties<test_struct, Damaging, Living, Naming>;   // duplicate of test_type_new
    using test_type2_new = add_properties<test_struct, Naming, Damaging, Living>;  // duplicate of test_type2_new
